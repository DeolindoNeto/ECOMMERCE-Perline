     ...
     <div class="divfixa">
        ...
        <?php 
            ...
            if ( $qtde == 0 )
            {
                ...
                pg_close($conecta);
        ?>
            <h1>Exclusão de Item-Venda</h1><br>
            ...
            <table class="table3">
               <tr align="left">
                ...
                <tr align="left">
                    ...
                    <th><input type='number' name="SELL_SOLD" size='26' value="<?php echo "".$linha['id_venda'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>ID do item:</p></th>
                    <th><input type="number" name="SELL_PRODUCT" value="<?php echo "".$linha['id_produto'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>Quantidade:</p></th>
                    <th><input type="number" name="SELL_QTDE" value="<?php echo "".$linha['qtde'].""; ?>" readonly></th>
                </tr>
                 <tr align="left">
                    <th><p>Data da venda:</p></th>
                    <th><input type="text" name="SELL_DATE" value="<?php echo "".$linha['data_hora_venda'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>Valor unitário:</p></th>
                    <th><input type="TEXT" name="SELL_VALUE_UNITARY" placeholder="Ex. 9.99"  value="<?php echo "".$linha['valor_unit'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>Valor total:</p></th>
                    <th><input type="TEXT" name="SELL_VALUE_TOTAL" placeholder="Ex. 9.99" value="<?php echo "".$linha['valor_total'].""; ?>" readonly></th>
                </tr>
                <tr>
                    <th colspan="2"><input type="submit" value="Excluir Item-Venda"></th>
                </tr>        
            </table>
            </form><br>
