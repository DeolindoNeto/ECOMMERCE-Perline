        ...
        ?>
            ...
            <table>
                ...
                <tr align="left">
                    ...
                    <th><input type="text" name="SELLBUYER"  value="<?php echo "".$linha['id_user'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>Data da venda:</p></th>
                    <th><input type="text" name="SELLDATE"  value="<?php echo "".$linha['data_hora_venda'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>Observações:</p></th>
                    <th><input type="text" name="SELLOBS"  value="<?php echo "".$linha['observacoes'].""; ?>" readonly></th>
                </tr>
                <tr align="left">
                    <th><p>Forma de Pagamento:</p></th>
                    <th><input type="text" name="SELLPAYMENT"  value="<?php echo "".$linha['forma_pgto'].""; ?>" readonly></th>
                </tr>
                <tr>
                    <th colspan="2"><input type="submit" value="Excluir Venda">
                </tr>        
            </table>
            </form><br>
