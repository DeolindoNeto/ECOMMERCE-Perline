...
<html lang="pt-br">
    ...
    <body>
        ...
        ?>
            ...
            <table>
               <label>ID:</label><input type="number" name="id_user" value="<?php echo "".$linha['id_user']; ?>" readonly>
                <tr align="left">
                    <th width="300px"><p>Nome:</p></th>
                    <th width="300px"><input type="text" name="USERNAME" maxlength="80" size="26" value="<?php echo "".$linha['nome_user'].""; ?>" required></th>
                </tr>
                <tr align="left">
                   <th><p>E-mail:</p></th>
                ...
                <tr align="left">
                   <th><p>Senha:</p></th>
                   <th><input type="password" name="USERSENHA" size="26" value="<?php echo "".$linha['senha_user'].""; ?>" required></th>
                </tr>
                <tr align="left">
                   <th><p>Telefone:</p></th>
